...
export const metadata: Metadata = {
  title: "Nosotros",
  description:
    "Conocé a Sendero Shop: figuras y accesorios de colección, fabricados a pedido desde Buenos Aires.",
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="space-y-6 text-lavanda-light leading-relaxed">
        <p>
          ...
          pasión por el diseño y la cultura geek. Desde Buenos Aires,
          diseñamos y fabricamos figuras, katanas, accesorios y piezas
          decorativas.
        </p>

        <p>
          Cada producto se fabrica a pedido, lo que nos permite ofrecer piezas
        ...
        <div className="bg-navy-deep border border-linea rounded-xl p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              },
              {
                step: "02",
                title: "Fabricación",
                desc: "Producimos cada pieza en nuestro taller, con control de calidad propio.",
              },
              {
                step: "03",
                title: "Acabado",
              ...
              <div key={item.step} className="text-center">
                ...
                <p className="text-sm text-texto-3 mt-1">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <p>
          ...
          cuidado y dedicación en cada una.
        </p>
