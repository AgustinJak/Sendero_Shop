 ...
 * El texto vive acá — editar libremente.
 */
  ...
  return (
    <div className="rounded-2xl border border-ambar/25 bg-gradient-to-br from-ambar/10 to-navy-deep p-5 sm:p-6">
      ...
      <a
        ...
        className="mt-4 w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-ambar hover:bg-ambar-light text-navy text-sm font-semibold rounded-lg transition-colors"
      >
