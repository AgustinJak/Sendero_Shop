// Sin framer-motion: las entradas son la misma animación atada al scroll que
// las tarjetas de producto (`aparecer-al-ver` en globals.css), sin JS.
  ...
  return (
    <section className="py-16 px-4 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
        {items.map((col) => (
          <div key={col.id} className="aparecer-al-ver transition-[scale] duration-200 hover:scale-[1.02]">
            <Link
  ...
  return (
    <section className="pb-16 px-4 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
        {items.map((cat) => (
          <div key={cat.id} className="aparecer-al-ver transition-[scale] duration-200 hover:scale-[1.02]">
            <Link
  ...
  return (
    <section className="py-16 px-4">
      <div className="max-w-3xl mx-auto text-center bg-navy-deep rounded-2xl p-8 sm:p-12 border border-linea">
        <h2 className="display display-seccion text-texto mb-4 aparecer-al-ver">
          ¿Tenés una idea en mente?
        </h2>
        <p className="text-texto-2 mb-6 aparecer-al-ver">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-8 py-3 bg-green-700 hover:bg-green-800 text-white font-semibold rounded-lg transition-colors aparecer-al-ver"
        >
